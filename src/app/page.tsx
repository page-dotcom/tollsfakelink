    ...
    <>
      ...
      <nav className="navbar navbar-custom navbar-fixed-top">
        <div className="container-fluid">
            <div className="navbar-header" style={{width:'100%', display:'flex', justifyContent:'space-between', alignItems:'center', paddingRight:15}}>
                ...
                <button onClick={handleLogout} className="btn btn-xs btn-danger" style={{fontWeight:'bold'}}>LOGOUT</button>
            </div>
        </div>
      </nav>
